 ...
 *
 */
package com.deloitte.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('merchandisestorefront.generic.cms.component.controller.authorized.group')}")
